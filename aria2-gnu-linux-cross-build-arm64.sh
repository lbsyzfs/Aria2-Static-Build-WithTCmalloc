...
BUILD_DIR="/tmp"
TOOL_BIN_DIR=/usr/local/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin
...
export CC="$TOOL_BIN_DIR/aarch64-linux-android34-clang"
export CXX="$TOOL_BIN_DIR/aarch64-linux-android34-clang++"
