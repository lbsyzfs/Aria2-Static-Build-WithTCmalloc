...
BUILD_DIR="/tmp"
TOOL_BIN_DIR=/usr/local/android-ndk-r25-beta1/toolchains/llvm/prebuilt/linux-x86_64/bin
...
export CC="$TOOL_BIN_DIR/aarch64-linux-android33-clang"
export CXX="$TOOL_BIN_DIR/aarch64-linux-android33-clang++"
export STRIP="$TOOL_BIN_DIR/llvm-strip"
export RANLIB="$TOOL_BIN_DIR/llvm-ranlib"
export AR="$TOOL_BIN_DIR/llvm-ar"
export LD="$TOOL_BIN_DIR/ld"
